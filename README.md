# my2sql
go版MySQL binlog解析工具，通过解析MySQL binlog ，可以生成原始SQL、数据恢复回滚SQL、去除主键的INSERT SQL等，也可以生成DML统计信息，节点数据库事务。

```
show master status

 -work-type  2sql,rollback,stats  (default "2sql")
 -mode       repl,file (default "repl")
 -tables     default all.
